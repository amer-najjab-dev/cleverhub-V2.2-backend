...
async function main() {
  ...
  // 3. Migrar datos privados con manejo de NULLs
  ...
  try {
    ...
    console.log('   ℹ️ Clientes: columna pharmacy_id no existe o ya actualizada')
  }
  ...
  try {
    ...
    console.log('   ℹ️ Inventory lots: columna pharmacy_id no existe o ya actualizada')
  }
  ...
  try {
    ...
    console.log('   ℹ️ Stock movements: columna pharmacy_id no existe o ya actualizada')
  }
  ...
  try {
    ...
    console.log('   ℹ️ Ventas: columna pharmacy_id no existe o ya actualizada')
  }
  ...
  try {
    ...
    console.log('   ℹ️ Proveedores: columna pharmacy_id no existe o ya actualizada')
  }
  ...
  if (!superAdminExists) {
    const hashedPassword = await bcrypt.hash(SEED_CONFIG.SUPER_ADMIN.password, 10)
